...
const dstJS = path.resolve(dstDir, "estado_cuenta_dashboard_build.js");
const dstCSS = path.resolve(dstDir, "estado_cuenta_dashboard.css");
...
const buildPath = path.resolve(srcDir, "estado_cuenta_dashboard_build.js");
